 ...
 * Credits go to Jeremeamia and its Acclimate/CompositeContainer
 */
class CompositeContainer implements ContainerInterface
{
    ...
    public function get($identifier)
    {
        ...
        throw new CompositeNotFoundException("There is no item in the container for the identifier \"{$identifier}\".");
    }
